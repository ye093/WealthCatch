...
public class HomeFragment extends BaseFragment {
    ...
    private static final String NEWS_URL = "http://m.159cai.com/hotnews/";
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    document.getElementsByClass("buyHeader").remove();
                    document.getElementsByClass("fixed app-footer").remove();
